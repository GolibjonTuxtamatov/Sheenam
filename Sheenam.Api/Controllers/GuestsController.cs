...
namespace Sheenam.Api.Controllers
{
    ...
    public class GuestsController : RESTFulController
    {
        ...
        public async ValueTask<ActionResult<Guest>> PutGuestAsync(Guest guest)
        {
            try
            {
                var putedGuest = await this.guestService.ModifyGuestAsync(guest);
        ...
        [HttpDelete("{id}")]
        public async ValueTask<ActionResult<Guest>> DeleteGuestAsync(Guid id)
        {
            try
            {
                var putedGuest = await this.guestService.DeleteGuestAsync(id);
